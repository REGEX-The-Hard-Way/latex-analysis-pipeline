#line 1 "macro_expanders/newcommand_expander.rl"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
#line 252 "macro_expanders/newcommand_expander.rl"



#line 84 "macro_expanders/newcommand_expander.c"
static const int newcommand_expander_start = 115;
static const int newcommand_expander_first_final = 115;
static const int newcommand_expander_error = -1;

static const int newcommand_expander_en_main = 115;


#line 254 "macro_expanders/newcommand_expander.rl"
...
#line 112 "macro_expanders/newcommand_expander.c"
	{
		cs = (int)newcommand_expander_start;
		ts = 0;
		te = 0;
	}
	
#line 275 "macro_expanders/newcommand_expander.rl"


#line 119 "macro_expanders/newcommand_expander.c"
{
		int _ck;
		switch ( cs ) {
			case 115:
		...
		_ctr118:
			{
#line 102 "macro_expanders/newcommand_expander.rl"
			{te = p+1;{
#line 102 "macro_expanders/newcommand_expander.rl"
...
#line 536 "macro_expanders/newcommand_expander.c"

		goto _st115;
		_ctr0:
			{
#line 249 "macro_expanders/newcommand_expander.rl"
			{p = ((te))-1;
				{
#line 249 "macro_expanders/newcommand_expander.rl"
					fputc(*ts, stdout); }
...
#line 547 "macro_expanders/newcommand_expander.c"

		goto _st115;
		_ctr2:
			{
#line 247 "macro_expanders/newcommand_expander.rl"
			{te = p+1;{
#line 247 "macro_expanders/newcommand_expander.rl"
					fwrite(ts, 1, te - ts, stdout); }
			}}
		
#line 557 "macro_expanders/newcommand_expander.c"

		goto _st115;
		_ctr101:
			{
#line 171 "macro_expanders/newcommand_expander.rl"
			{p = ((te))-1;
				{
#line 171 "macro_expanders/newcommand_expander.rl"
...
#line 643 "macro_expanders/newcommand_expander.c"
...
#line 653 "macro_expanders/newcommand_expander.c"
...
#line 663 "macro_expanders/newcommand_expander.c"
...
#line 748 "macro_expanders/newcommand_expander.c"

				goto _st115;
				_ctr139:
					{
#line 163 "macro_expanders/newcommand_expander.rl"
					{te = p;p = p - 1;{
#line 163 "macro_expanders/newcommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 758 "macro_expanders/newcommand_expander.c"

				goto _st115;
				_ctr143:
					{
#line 165 "macro_expanders/newcommand_expander.rl"
					{te = p;p = p - 1;{
#line 165 "macro_expanders/newcommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 768 "macro_expanders/newcommand_expander.c"

				goto _st115;
				_ctr147:
					{
#line 164 "macro_expanders/newcommand_expander.rl"
					{te = p;p = p - 1;{
#line 164 "macro_expanders/newcommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 778 "macro_expanders/newcommand_expander.c"

				goto _st115;
				_ctr150:
					{
#line 169 "macro_expanders/newcommand_expander.rl"
					{te = p;p = p - 1;{
#line 169 "macro_expanders/newcommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 788 "macro_expanders/newcommand_expander.c"

				goto _st115;
				_ctr173:
					{
#line 168 "macro_expanders/newcommand_expander.rl"
					{te = p;p = p - 1;{
#line 168 "macro_expanders/newcommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 798 "macro_expanders/newcommand_expander.c"

				goto _st115;
				_ctr185:
					{
#line 167 "macro_expanders/newcommand_expander.rl"
					{te = p;p = p - 1;{
#line 167 "macro_expanders/newcommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 808 "macro_expanders/newcommand_expander.c"

				goto _st115;
				_ctr189:
					{
#line 166 "macro_expanders/newcommand_expander.rl"
					{te = p;p = p - 1;{
#line 166 "macro_expanders/newcommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 818 "macro_expanders/newcommand_expander.c"
...
#line 827 "macro_expanders/newcommand_expander.c"
...
#line 836 "macro_expanders/newcommand_expander.c"
...
#line 855 "macro_expanders/newcommand_expander.c"
...
#line 2935 "macro_expanders/newcommand_expander.c"
...
#line 3231 "macro_expanders/newcommand_expander.c"
...
#line 3238 "macro_expanders/newcommand_expander.c"
...
#line 3245 "macro_expanders/newcommand_expander.c"
				...
				if ( p == eof ) {
					...
					switch( ( (*( p))) ) {
						...
						case 125: {
							_ck = 0;
							if ( (!n)
#line 3264 "macro_expanders/newcommand_expander.c"
 )
							_ck += 1;
							if ( _ck > 0 ) {
								goto _ctr118;
...
#line 276 "macro_expanders/newcommand_expander.rl"
