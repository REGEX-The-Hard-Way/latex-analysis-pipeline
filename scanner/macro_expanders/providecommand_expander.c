#line 1 "macro_expanders/providecommand_expander.rl"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
#line 260 "macro_expanders/providecommand_expander.rl"



#line 91 "macro_expanders/providecommand_expander.c"
static const int providecommand_expander_start = 115;
static const int providecommand_expander_first_final = 115;
static const int providecommand_expander_error = -1;

static const int providecommand_expander_en_main = 115;


#line 262 "macro_expanders/providecommand_expander.rl"
...
#line 119 "macro_expanders/providecommand_expander.c"
	{
		cs = (int)providecommand_expander_start;
		ts = 0;
		te = 0;
	}
	
#line 283 "macro_expanders/providecommand_expander.rl"


#line 126 "macro_expanders/providecommand_expander.c"
{
		int _ck;
		switch ( cs ) {
			case 115:
		...
		_ctr118:
			{
#line 109 "macro_expanders/providecommand_expander.rl"
			{te = p+1;{
#line 109 "macro_expanders/providecommand_expander.rl"
...
#line 544 "macro_expanders/providecommand_expander.c"

		goto _st115;
		_ctr0:
			{
#line 257 "macro_expanders/providecommand_expander.rl"
			{p = ((te))-1;
				{
#line 257 "macro_expanders/providecommand_expander.rl"
					fputc(*ts, stdout); }
...
#line 555 "macro_expanders/providecommand_expander.c"

		goto _st115;
		_ctr2:
			{
#line 255 "macro_expanders/providecommand_expander.rl"
			{te = p+1;{
#line 255 "macro_expanders/providecommand_expander.rl"
					fwrite(ts, 1, te - ts, stdout); }
			}}
		
#line 565 "macro_expanders/providecommand_expander.c"

		goto _st115;
		_ctr101:
			{
#line 179 "macro_expanders/providecommand_expander.rl"
			{p = ((te))-1;
				{
#line 179 "macro_expanders/providecommand_expander.rl"
...
#line 651 "macro_expanders/providecommand_expander.c"
...
#line 661 "macro_expanders/providecommand_expander.c"
...
#line 671 "macro_expanders/providecommand_expander.c"
...
#line 756 "macro_expanders/providecommand_expander.c"

				goto _st115;
				_ctr139:
					{
#line 171 "macro_expanders/providecommand_expander.rl"
					{te = p;p = p - 1;{
#line 171 "macro_expanders/providecommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 766 "macro_expanders/providecommand_expander.c"

				goto _st115;
				_ctr143:
					{
#line 173 "macro_expanders/providecommand_expander.rl"
					{te = p;p = p - 1;{
#line 173 "macro_expanders/providecommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 776 "macro_expanders/providecommand_expander.c"

				goto _st115;
				_ctr147:
					{
#line 172 "macro_expanders/providecommand_expander.rl"
					{te = p;p = p - 1;{
#line 172 "macro_expanders/providecommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 786 "macro_expanders/providecommand_expander.c"

				goto _st115;
				_ctr150:
					{
#line 177 "macro_expanders/providecommand_expander.rl"
					{te = p;p = p - 1;{
#line 177 "macro_expanders/providecommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 796 "macro_expanders/providecommand_expander.c"

				goto _st115;
				_ctr160:
					{
#line 175 "macro_expanders/providecommand_expander.rl"
					{te = p;p = p - 1;{
#line 175 "macro_expanders/providecommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 806 "macro_expanders/providecommand_expander.c"

				goto _st115;
				_ctr185:
					{
#line 176 "macro_expanders/providecommand_expander.rl"
					{te = p;p = p - 1;{
#line 176 "macro_expanders/providecommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 816 "macro_expanders/providecommand_expander.c"

				goto _st115;
				_ctr189:
					{
#line 174 "macro_expanders/providecommand_expander.rl"
					{te = p;p = p - 1;{
#line 174 "macro_expanders/providecommand_expander.rl"
							fwrite(ts, 1, te - ts, stdout); }
					}}
				
#line 826 "macro_expanders/providecommand_expander.c"
...
#line 835 "macro_expanders/providecommand_expander.c"
...
#line 844 "macro_expanders/providecommand_expander.c"
...
#line 863 "macro_expanders/providecommand_expander.c"
...
#line 3248 "macro_expanders/providecommand_expander.c"
...
#line 3544 "macro_expanders/providecommand_expander.c"
...
#line 3551 "macro_expanders/providecommand_expander.c"
...
#line 3558 "macro_expanders/providecommand_expander.c"
				...
				if ( p == eof ) {
					...
					switch( ( (*( p))) ) {
						...
						case 125: {
							_ck = 0;
							if ( (!n)
#line 3577 "macro_expanders/providecommand_expander.c"
 )
							_ck += 1;
							if ( _ck > 0 ) {
								goto _ctr118;
...
#line 284 "macro_expanders/providecommand_expander.rl"

			
			if (cs == providecommand_expander_error) {
